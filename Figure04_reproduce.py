...
# - P0 = 20 dBm, N = 20, N0 = 0 dBm
# - K = 4, Gamma = 10 dB
# - Separated: NR = 14, NC = 6, PR = PC = P0/2
# - 3dB beampattern formulation:
#       main beam centered at 0 degree
#       3dB beamwidth = 10 degree
# - Radar-only uses (13) / (10)
# - RadCom uses SDR relaxations of (19) / (20)
#
# Note:
# Exact pixel-perfect duplication of the published figure is not guaranteed,
# because the paper does not publish the exact random channel realization,
# random seed, or every plotting normalization detail. This script reproduces
# the methodology and the figure shape closely.
# ============================================================
...
def solve_radar_only_separated_3db(NR, PR, angle_grid_deg, f_list, theta0=0.0, beamwidth_3db=10.0, solvers=None, verbose=False):
    """
